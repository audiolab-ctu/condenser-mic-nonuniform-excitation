...
import os
from functions_CondMic_NonUnifExc import plot_ximean_mn_Full_NONunifload_angleParallel
...
No_parts = 4 #number of parts of electrode
...
#Incident angles
Angle_points =90 #number of angular points
alpha = np.arange(0, 2*pi, 2*pi/Angle_points) #incident angles [rad]
...
#Comsol filenames
if freq == 100:
    filenameComs = ('Angle_100Hz.txt')
elif freq == 500:
    filenameComs = ('Angle_500Hz.txt')
elif freq == 1000:
    filenameComs = ('Angle_1kHz.txt')
elif freq == 2000:
    filenameComs = ('Angle_2kHz.txt')
elif freq == 5000:
    filenameComs = ('Angle_5kHz.txt')
else:
    filenameComs = ''
...
if __name__ == "__main__":
    plot_ximean_mn_Full_NONunifload_angleParallel(R_modes, Theta_modes, R, ms, T, p_inc, c0, alpha, Rh, Lh, R_h_coord, theta_h_coord, hg, hc, Rc, rho0, mu, gamma, Cp, lamh, No_parts, filenameComs, ImpCav, freq)
